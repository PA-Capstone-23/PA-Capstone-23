...
//        
//        // Di sini Anda dapat memeriksa kredensial dan peran pengguna
//        // Sesuaikan dengan logika autentikasi Anda
//        if (selectedRole.equals("Pengunjung")) {
//            try {
//            String sql = "SELECT * FROM pengunjung WHERE username ='" + usernameLogin.getText() + "'AND password ='" + passwordLogin.getText() +"'";
...
//        }
////            JOptionPane.showMessageDialog(this, "Login Pengunjung berhasil");
//        } else if (selectedRole.equals("Admin")) {
//            if (username.equals("taufik") && password.equals("hidayat")){
//                MenuAdmin Admin1 = new MenuAdmin();
//                Admin1.setVisible(true);
//                this.dispose();
//                JOptionPane.showMessageDialog(this, "Login Admin berhasil");
...
//            }
//            // Lakukan sesuatu untuk login sebagai admin
//            
//        } else {
