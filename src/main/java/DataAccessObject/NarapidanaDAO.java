...
//    try {
//        this.openConnection();
////        this.resultSet = .executeQuery("SELECT * FROM data_mahasiswa");
//        String sql = "SELECT * FROM narapidana";
//        this.resultSet = this.preparedStatement.executeQuery(sql);
//        DefaultTableModel model = new DefaultTableModel();  
//        
//        model.addColumn("id_napi");
//        model.addColumn("nama");
//        model.addColumn("umur");
//        model.addColumn("jenis_kelamini");
//        model.addColumn("tgl_masuk");
//        model.addColumn("tgl_keluar");
//        model.addColumn("masa_tahanan");
//        
//        int no = 1;
//        
...
//        Object[] data = {
//            no++,
//         this.resultSet.getString("id_napi"),
//         this.resultSet.getString("nama"),
//         this.resultSet.getString("umur"),
//         this.resultSet.getString("jenis_kelamin"),
//         this.resultSet.getString("tgl_masuk"),
//         this.resultSet.getString("tgl_keluar"),
//         this.resultSet.getString("masa_tahanan")
//        };
//        return data;
////        model.addRow(data);
////        readTableNapi.setModel(model);
////        return model;
//            }
//        } catch (SQLException ex) {
//            this.displayErrors(ex);
...
//    
//   }
//   public List<Object[]> tabelNapi() {
//        List<Object[]> dataList = new ArrayList<>();
//        try {
//            this.openConnection();
//            this.preparedStatement = this.connection.prepareStatement("SELECT * FROM narapidana");
//            
//            this.resultSet = this.preparedStatement.executeQuery();
//            while (this.resultSet.next()) {
//                Object[] data = {
//                    this.resultSet.getInt("id_napi"),
//                    this.resultSet.getString("nama_napi"),
//                    this.resultSet.getInt("umur"),
//                    this.resultSet.getString("jenis_kelamin"),
//                };
//                dataList.add(data);
//            }
...
//        return dataList;
//    }
//   public List<Object[]> tabelHukuman() {
//        List<Object[]> dataList = new ArrayList<>();
//        try {
//            this.openConnection();
//            this.preparedStatement = this.connection.prepareStatement("SELECT * FROM narapidana");
...
//        return dataList;
//    }
//    public List<Object[]> tabelProgram() {
//        List<Object[]> dataList = new ArrayList<>();
//        try {
//            this.openConnection();
//            this.preparedStatement = this.connection.prepareStatement("SELECT * FROM napi_lapas");
//            
//            this.resultSet = this.preparedStatement.executeQuery();
//            while (this.resultSet.next()) {
//                Object[] data1 = {
//                    this.resultSet.getInt("id_napi"),
//                    this.resultSet.getString("program_rehab"),                    
//                };
//                dataList.add(data1);
//            }
//            this.preparedStatement = this.connection.prepareStatement("SELECT * FROM napi_program");
//            
//            this.resultSet = this.preparedStatement.executeQuery();
//            while (this.resultSet.next()) {
//                Object[] data2 = {
//                    this.resultSet.getString("program"),                    
//                };
//                dataList.add(data2);
//            }
//        } catch (SQLException ex) {
...
//            this.resultSet = this.preparedStatement.executeQuery(sql);
//            while(this.resultSet.next()){
//                this.idNapi = this.resultSet.getInt("id_napi");
//                String idStr = Integer.toString(idInt); 
////                this.idNapi = idStr;
//                this.namaNapi=  this.resultSet.getString("nama_napi");
//                this.umur = this.resultSet.getInt("umur");
////                int umurInt = this.resultSet.getInt("umur");
////                String umurStr = Integer.toString(umurInt); 
//                this.jenisKelamin = this.resultSet.getString("jenis_kelamin");
//                this.tglMasuk = this.resultSet.getString("tgl_masuk");
//                this.tglKeluar = this.resultSet.getString("tgl_keluar");
//                this.masaTahanan = this.resultSet.getString("masa_tahanan");
//                String tbData[] = {idStr,this.namaNapi,umurStr,this.jenisKelamin,this.tglMasuk,this.tglKeluar,this.masaTahanan};
//                DefaultTableModel tblModel = (DefaultTableModel)MenuAdmin.readTableNapi.getModel();
//                isOperationSuccess = true;
//            }
//        }catch (SQLException ex){
//            this.displayErrors(ex);
