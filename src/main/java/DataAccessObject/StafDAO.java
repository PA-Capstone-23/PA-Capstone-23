...
//        try {
//            this.openConnection();
//            this.preparedStatement = this.connection.prepareStatement("SELECT * FROM staf");
//            
//            this.resultSet = this.preparedStatement.executeQuery();
//            while (this.resultSet.next()) {
//                Object[] data = {
//                    this.resultSet.getString("nip"),
//                    this.resultSet.getString("nama_staf"),
//                    this.resultSet.getString("jabatan"),
//                    this.resultSet.getString("staf_nip"),
//                };
//                dataList.add(data);
//            }
//        } catch (SQLException ex) {
